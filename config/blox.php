...
return [
    ...
    'featured_items' => [1, 2],
    'render' => [
        'url' => 'https://server.bloxcity.net',
        'key' => 'key'
    ],
	'item_notifier' => [
        'enabled' => true,
        'url' => 'https://discord.com/api/webhooks/1242943882052767825/X98Hc1SYkX2l-RcqPOZG1eAClRZf1pevElIKKtFhRJdM2Shtz54tO96DX2SkCMYOuc9n'
    ],
    'market_categories' => [
	    [
            'id' => 5,
    ...
    'domains' => [
        ...
        'blog' => 'https://blog.bloxcity.net',
        'corp' => 'https://corp.bloxcity.net'
    ],
    'emails' => [
        'support' => 'hello@bloxcity.net',
        'moderation' => 'moderation@bloxcreate.com',
        'careers' => 'hello@bloxcity.net',
        'payments' => 'payments@bloxcity.net'
    ],
    'socials' => [
        'discord' => 'https://discord.gg/bloxcity',
        'twitter' => 'https://twitter.com/bloxcitynet',
        'youtube' => '/'
    ],
    'forum_banners' => [
    ...
    'maintenance_passcodes' => [
        'TESTKEY13022021FORPREVIEWANDOTHERSTUFF28282030482982'
    ],
    'daily_cash' => [
        'VIP_0' => 15,
        'VIP_1' => 20,
